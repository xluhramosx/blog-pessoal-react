...
function CardPostagem() {
  return (
    <div className="border-slate-900 border flex flex-col rounded overflow-hidden justify-between">
      <div>
        <div className="flex w-full bg-violet-400 py-2 px-4 items-center gap-4">
      ...
      <div className="flex">
        <Link
          to=""
          className="w-full text-white bg-violet-400 hover:bg-violet-800 flex items-center justify-center py-2"
        >
